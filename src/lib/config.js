...
const config = {
  ...
  daily: {
    ...
    dueLookaheadSeconds: intOpt('DUE_LOOKAHEAD_SECONDS', 300),
    // Confidence tiers (percent) — below `good` a prediction is NOT posted.
    confElite: intOpt('CONF_ELITE', 90),
    confStrong: intOpt('CONF_STRONG', 80),
    confGood: intOpt('CONF_GOOD', 70),
  },
  leaguePolicy: {
